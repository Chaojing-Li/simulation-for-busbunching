...
class Network(ABC):
    ...
    _name_coordinates: Dict[str, Tuple[float, float]]

    def __init__(self) -> None:
        self._G = nx.DiGraph()
        self._name_coordinates = {}
    ...
    # Doing this ensures that subclasses of Network
    # will return the correct type when calling `define_network`.
    @abstractmethod
